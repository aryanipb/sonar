...
from ModelNetDatasetFewShot import ModelNet40FewShot
...
def main():
    ...
    train_loader = DataLoader(ModelNet40FewShot(partition='train', num_points=args.num_points), num_workers=args.workers,
                              batch_size=args.batch_size, shuffle=True, drop_last=True)
    test_loader = DataLoader(ModelNet40FewShot(partition='test', num_points=args.num_points), num_workers=args.workers,
